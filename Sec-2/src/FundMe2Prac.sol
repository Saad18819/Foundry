...
contract FundMe2Prac {
    ...
    function getAddToAmnt(address abc) external view returns(uint256){
        return addressToAmountFunded[abc];
    }

    function getAdd(uint256 index) external view returns(address){
